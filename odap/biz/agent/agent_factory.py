...
try:
    from odap.biz.agent.swarm_orchestrator import AgentType, AgentState, AgentConfig
except ImportError:
...
def get_agent_factory() -> AgentFactory:
    ...
    if _global_agent_factory is None:
        ...
        try:
            from odap.biz.agent.swarm_orchestrator import CommanderAgent, IntelligenceAgent, OperationsAgent
