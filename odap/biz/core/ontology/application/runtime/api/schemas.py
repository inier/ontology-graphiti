...
class CreateContractRequest(BaseModel):
    ...
    action_name: str = ""
    description: str = ""
    read_set: List[ContractEntryRequest] = Field(default_factory=list)
    write_set: List[ContractEntryRequest] = Field(default_factory=list)
    side_effect_set: List[ContractEntryRequest] = Field(default_factory=list)
