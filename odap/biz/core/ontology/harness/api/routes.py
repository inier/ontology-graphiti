...
@router.post("/sessions/{session_id}/fail", response_model=dict)
...
@router.post("/sessions/{session_id}/hitl", response_model=dict)
...
@router.post("/sessions/{session_id}/hitl/resolve", response_model=dict)
...
@router.post("/hitl/check", response_model=dict)
...
@router.post("/sessions/{session_id}/tasks", response_model=dict)
...
@router.put("/sessions/{session_id}/tasks", response_model=dict)
...
@router.post("/blueprints", response_model=dict)
...
@router.get("/blueprints/{blueprint_id}", response_model=dict)
...
@router.put("/blueprints/{blueprint_id}", response_model=dict)
...
@router.delete("/blueprints/{blueprint_id}", response_model=dict)
