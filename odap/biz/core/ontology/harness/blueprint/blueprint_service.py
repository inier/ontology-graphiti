...
class BlueprintDesignerService:
    ...
    def __init__(self, storage=None, version_storage=None):
        from odap.biz.core.ontology.harness.blueprint.storage import BlueprintStorage, BlueprintVersionStorage
    ...
    def _generate_code(self, blueprint: Dict[str, Any]) -> str:
        ...
        lines.append("from odap.biz.core.ontology.services.pipeline_service import PipelineService")
        lines.append("")
