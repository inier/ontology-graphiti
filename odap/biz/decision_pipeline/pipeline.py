...
class DecisionPipeline:
    ...
    def decision_engine(self):
        if self._decision_engine is None:
            try:
                from odap.biz.decision_recommendation.engine import DecisionRecommendationEngine
    ...
    def action_executor(self):
        if self._action_executor is None:
            from odap.biz.action_service.executor import get_action_executor
    ...
    def feedback_loop(self):
        if self._feedback_loop is None:
            from odap.biz.action_service.feedback_loop import get_feedback_loop
    ...
    async def _decide(self, analysis: AnalysisResult, input_data: AnalysisInput) -> DecisionResult:
        if self.decision_engine:
            try:
                from odap.biz.decision_recommendation.models import RecommendationRequest
    ...
    async def _perform(self, decision: DecisionResult, input_data: AnalysisInput) -> Dict[str, Any]:
        from odap.biz.action_service.schemas import ActionRequest
