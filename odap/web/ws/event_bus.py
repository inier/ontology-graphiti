...
class DomainEventBus:
    def __init__(self):
        ...
        self._workspace_clients: Dict[str, Set[WebSocket]] = defaultdict(set)
        self._subscribers: Dict[str, list] = defaultdict(list)
        self._event_history: list = []
        self._max_history = 1000

    async def connect(self, websocket: WebSocket, workspace_id: Optional[str] = None):
    ...
    def disconnect(self, websocket: WebSocket, workspace_id: Optional[str] = None):
