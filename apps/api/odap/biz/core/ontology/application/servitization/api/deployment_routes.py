...
from .deployment_schemas import DeployRequest, DictResponse
...
@router.post("/{deployment_id}/stop", response_model=DictResponse)
...
@router.post("/{deployment_id}/rollback", response_model=DictResponse)
...
@router.get("/{deployment_id}/health", response_model=DictResponse)
...
@router.post("/health-check", response_model=DictResponse)
...
@router.get("/{deployment_id}", response_model=DictResponse)
