"""结构化查询任务规划器（迁移副本，原始位置位于 semantic_layer）

本模块从 odap/biz/core/ontology/design/schema/semantic_layer/query_planner.py
迁移至 biz.data.qa.nl_pipeline 领域。Iter 1 为迁移阶段，Iter 4 将删除原目录副本。
"""
    ...
    def __init__(self):
        ...
        self._task_templates = {
            ...
            "compare": [
                ...
                {
                    "step": 2,
                    "task_type": "entity_identification",
                    "description": "实体识别",
                },
                {
                    "step": 3,
                ...
                {
                    "step": 4,
                    "task_type": "comparison_generation",
                    "description": "对比生成",
                },
            ],
        }
