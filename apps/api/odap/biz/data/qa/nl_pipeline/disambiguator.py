"""术语消歧与扩展（迁移副本，原始位置位于 semantic_layer）

本模块从 odap/biz/core/ontology/design/schema/semantic_layer/disambiguator.py
...
class Disambiguator:
    ...
    def load_domain(
        self, domain_name: str, semantic_config: Dict[str, Any]
    ) -> Dict[str, Any]:
