...
class ConfigurationComposer:
    ...
    def _init_system_defaults(self):
        defaults = {
            ...
            "llm.embedder_model": ConfigSchema("llm.embedder_model", str, "text-embedding-3-small", description="嵌入模型名称"),
            "llm.embedder_provider": ConfigSchema("llm.embedder_provider", str, "auto", description="嵌入服务提供方式: auto/api/local"),
            "llm.embedder_local_model": ConfigSchema("llm.embedder_local_model", str, "BAAI/bge-small-zh-v1.5", description="本地嵌入模型名称"),
    ...
    def _load_env_layer(self):
        mapping = {
            ...
            "EMBEDDER_MODEL": "llm.embedder_model",
            "EMBEDDER_PROVIDER": "llm.embedder_provider",
            "EMBEDDER_LOCAL_MODEL": "llm.embedder_local_model",
