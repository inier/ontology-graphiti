...
class TestBlueprintDesignerService:
    ...
    def test_singleton(self, tmp_path):
        ...
        from odap.biz.core.ontology.application.harness.blueprint import get_blueprint_designer
...
class TestBlueprintEnums:
    def test_node_type_enum(self):
        from odap.biz.core.ontology.application.harness.blueprint.api.schemas import BlueprintNodeType
    ...
    def test_edge_type_enum(self):
        from odap.biz.core.ontology.application.harness.blueprint.api.schemas import BlueprintEdgeType
    ...
    def test_enum_str_inheritance(self):
        from odap.biz.core.ontology.application.harness.blueprint.api.schemas import BlueprintNodeType, BlueprintEdgeType
