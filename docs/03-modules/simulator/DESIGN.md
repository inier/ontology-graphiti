...
| 概念 | 职责 | 模块位置 |
|------|------|---------|
| **Mock 数据生成** | 为构建领域本体生成样本数据（静态） | `apps/api/odap/biz/core/ontology/mock_data/` |
| **模拟推演** | 对选定方案进行沙盘验证（动态） | `apps/api/odap/biz/simulation/` |
...
- [ADR-018: 领域模拟推演引擎](../../07-adr/ADR-018_domain_simulator_engine.md)
- [Mock 数据生成模块](../../07-adr/README.md)
