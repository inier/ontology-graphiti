...
**版本**: 3.0 | **日期**: 2026-04-11 | **架构师**: 软件架构师
...
| **工作空间隔离** | 多场景数据完全隔离，通过命名空间实现 |
| **本体为核心** | 以 Ontology 为核心，实现语义级别的理解和推理 |
| **技能可热插拔** | Skill 注册无需重启，配置变更热生效 |
| **OpenHarness First** | 基于 OpenHarness 作为 Agent 基础设施 |
...
│  ├─────────────────────────────────────────────────────────────┤   │
│  │                                                             │   │
│  │   GitHub: harness-core / harness-python-sdk (MIT)         │   │
│  │                                                             │   │
│  │   ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐   │   │
...
| 组件 | 协议 | 地址 |
|------|------|------|
| OpenHarness Python SDK | MIT | github.com/harness-core/harness-python-sdk |
...
**后果**:
- ✅ **开源免费**：OpenHarness SDK + LangGraph 均 MIT 协议
...
|---|----------|----------|----------|--------|
| **A** | ⚠️ **通用本体驱动平台（核心定位）** | F-100 | **ADR-022, ADR-023** | P0 |
| **B** | ⚠️ **多工作空间隔离管理** | F-101, F-102 | **ADR-022** | P0 |
...
| **工作空间管理** | **F-100** | **第13章** | **ADR-022** |
| **工作空间隔离** | **F-101** | **第13章** | **ADR-022** |
| **本体驱动核心** | **F-102** | **第13章** | **ADR-023** |
...
| **ADR-022** | **多工作空间隔离架构** | **F-100, F-101, F-102** |
| **ADR-023** | **本体驱动分析核心架构** | **F-100, F-102** |
| ADR-020 | 战争实体标准本体库 | F-021, F-090 |
| ADR-021 | 模拟数仓与统一查询服务 | F-091 |
