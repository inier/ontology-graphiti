...
| **Orient 理解** | Intelligence | 感知数据 + 本体知识 | 评估、关联分析 | Graphiti 时序推理、本体模型 |
...
| ADR-021 | 领域实体标准本体库 | 已接受 | [adr/ADR-021_领域实体标准本体库.md](adr/ADR-021_领域实体标准本体库.md) |
...
| 6 | **领域实体本体库（中英文说明）** | F-090 | **ADR-021** | P0 |
