...
| ADR-037 | 前端采用移动优先 + 国际化架构 | 已接受 | P0 | [ADR-037](ADR-037_frontend_mobile_first_i18n.md) |
...
| ADR-041 | 工作空间资源隔离架构 | 已接受 | P0 | [ADR-041](ADR-041_workspace_resource_isolation.md) |
| ADR-042 | 审计日志存储查询架构 | 已接受 | P0 | [ADR-042](ADR-042_audit_log_storage_query.md) |
...
| ADR-018 | 模拟领域数据生成引擎 | 已接受 | P1 | [ADR-018](ADR-018_domain_simulator_engine.md) |
| ADR-036 | 领域实体标准本体库（Palantir 参考） | 已接受 | P1 | [ADR-036](ADR-036_palantir_ontology_reference.md) |
...
| ADR | 决策标题 | 状态 | 优先级 | 文件 |
|-----|---------|------|--------|------|
| ADR-052 | 智能问答WebUI开源项目选型 | 提议 | P0 | [ADR-052](ADR-052_webui_opensource_selection.md) |
| ADR-053 | Skill可视化管理开源方案选型 | 提议 | P0 | [ADR-053](ADR-053_skill_management_selection.md) |
...
| ADR-039 | 问答引擎架构 | 已接受 | P0 | [ADR-039](ADR-039_qa_engine_architecture.md) |
| ADR-040 | API 网关统一入口 | 已接受 | P0 | [ADR-040](ADR-040_api_gateway_unified_entry.md) |
...
| ADR | 决策标题 | 状态 | 文件 |
|-----|---------|------|------|
| ADR-001 | Agent 基础设施（OpenHarness + LangGraph） | 已接受 | [ADR-001](ADR-001_agent_基础设施openharness_langgraph.md) |
| ADR-002 | Graphiti 作为双时态知识图谱 | 已接受 | [ADR-002](ADR-002_graphiti_作为双时态知识图谱.md) |
| ADR-003 | OPA 策略治理引擎（MVP + 生产化） | 已接受 | [ADR-003](ADR-003_opa_策略治理引擎mvp_生产化.md) |
| ADR-004 | 统一 Skill 体系架构 | 已接受 | [ADR-004](ADR-004_统一_skill_体系架构.md) |
| ADR-005 | 分层 Agent 架构（OpenHarness 原生 + 领域扩展） | 已接受 | [ADR-005](ADR-005_分层_agent_架构openharness_原生_领域扩展.md) |
| ADR-006 | OpenHarness 复用策略（完全复用 + 适配复用 + 独立扩展） | 已接受 | [ADR-006](ADR-006_openharness_复用策略完全复用_适配复用_独立扩展.md) |
| ADR-007 | 前端采用 React + Ant Design 技术栈 | 已接受 | [ADR-007](ADR-007_前端采用_react_ant_design_技术栈.md) |
| ADR-008 | 审计日志完整记录 | 已接受 | [ADR-008](ADR-008_审计日志完整记录.md) |
| ADR-009 | Markdown 编写 OPA 策略 | 已接受 | [ADR-009](ADR-009_markdown_编写_opa_策略.md) |
| ADR-010 | 多模态文档处理可配置 | 已接受 | [ADR-010](ADR-010_多模态文档处理可配置.md) |
| ADR-011 | 角色配置热生效 | 已接受 | [ADR-011](ADR-011_角色配置热生效.md) |
| ADR-012 | 配置组合引擎 | 已接受 | [ADR-012](ADR-012_配置组合引擎.md) |
| ADR-013 | 多数据源统一接入 | 已接受 | [ADR-013](ADR-013_多数据源统一接入.md) |
| ADR-014 | 技能热插拔架构 | 已接受 | [ADR-014](ADR-014_技能热插拔架构.md) |
| ADR-015 | 可扩展图表系统 | 已接受 | [ADR-015](ADR-015_可扩展图表系统.md) |
| ADR-016 | 完备文档体系 | 已接受 | [ADR-016](ADR-016_完备文档体系.md) |
| ADR-017 | 原子提交规范 | 已接受 | [ADR-017](ADR-017_原子提交规范.md) |
| ADR-018 | 模拟领域数据生成引擎 | 已接受 | [ADR-018](ADR-018_domain_simulator_engine.md) |
| ADR-019 | 多模态文档处理流水线 | 已接受 | [ADR-019](ADR-019_多模态文档处理流水线.md) |
| ADR-020 | 管理员控制台统一界面 | 已接受 | [ADR-020](ADR-020_管理员控制台统一界面.md) |
| ADR-021 | QA驱动本体搭建架构 | 已接受 | [ADR-021](ADR-021_qa_driven_ontology_building.md) |
| ADR-022 | 模拟数仓与统一查询服务 | 提议中 | [ADR-022](ADR-022_模拟数仓与统一查询服务.md) |
| ADR-023 | 多工作空间隔离架构 | 已接受 | [ADR-023](ADR-023_多工作空间隔离架构.md) |
| ADR-024 | 本体驱动分析核心架构 | 已接受 | [ADR-024](ADR-024_本体驱动分析核心架构.md) |
| ADR-025 | 基于 OpenHarness 实现多智能体协同 | 已接受 | [ADR-025](ADR-025_openharness_integration.md) |
| ADR-026 | 采用 MCP 协议作为外部系统集成标准 | 已接受 | [ADR-026](ADR-026_mcp_protocol_integration.md) |
| ADR-027 | Hook 系统作为可扩展性核心架构 | 已接受 | [ADR-027](ADR-027_hook_system_architecture.md) |
| ADR-028 | OPA 作为统一权限校验引擎 | 已接受 | [ADR-028](ADR-028_permission_checker_opa_integration.md) |
| ADR-029 | 统一工具注册表架构管理 AI Agent 工具 | 已接受 | [ADR-029](ADR-029_tool_registry_architecture.md) |
| ADR-030 | Phase 1 推迟引入 OpenHarness，保留现有编排器 | 已接受 | [ADR-030](ADR-030_phase1_推迟引入openharness_保留现有编排器.md) |
| ADR-031 | 模拟器 Web 可视化与实时本体热写入架构 | 已接受 | [ADR-031](ADR-031_simulator_web_visualization_realtime_ontology.md) |
| ADR-032 | 标准化本体文档格式（OntologyDocument） | 已接受 | [ADR-032](ADR-032_standard_ontology_document_format.md) |
| ADR-033 | 项目目录结构重构（分层模块化 odap/ 包） | 提议 | [ADR-033](ADR-033_项目目录结构重构.md) |
| ADR-036 | 领域实体标准本体库（Palantir 参考） | 已接受 | [ADR-036](ADR-036_palantir_ontology_reference.md) |
| ADR-037 | 前端采用移动优先 + 国际化架构 | 已接受 | [ADR-037](ADR-037_frontend_mobile_first_i18n.md) |
| ADR-038 | 本体管理引擎与用户认知引擎架构 | 已接受 | [ADR-038](ADR-038_本体管理引擎与用户认知引擎架构.md) |
| ADR-039 | 问答引擎架构 | 已接受 | [ADR-039](ADR-039_qa_engine_architecture.md) |
| ADR-040 | API 网关统一入口 | 已接受 | [ADR-040](ADR-040_api_gateway_unified_entry.md) |
| ADR-041 | 工作空间资源隔离架构 | 已接受 | [ADR-041](ADR-041_workspace_resource_isolation.md) |
| ADR-042 | 审计日志存储查询架构 | 已接受 | [ADR-042](ADR-042_audit_log_storage_query.md) |
| ADR-043 | Agent Router 语义路由架构 | 已接受 | [ADR-043](ADR-043_agent_router_semantic_routing.md) |
| ADR-044 | 测试策略与框架 | 已接受 | [ADR-044](ADR-044_test_strategy_framework.md) |
...
- ADR-034 ~ ADR-038：Phase 4 文档体系（前端 i18n、本体管理+认知引擎等）。注：ADR-034/035 为预留编号，对应设计已合并至 ADR-038
